...
class Tenants extends \Aurora\System\Managers\AbstractManager
{
	...
	public function getTenantList($iOffset = 0, $iLimit = 0, $sOrderBy = 'Name', $iOrderType = \Aurora\System\Enums\SortOrder::ASC, $sSearchDesc = '')
	{
		...
		try
		{
			$aResult = $this->oEavManager->getEntities(
				\Aurora\Modules\Core\Module::getNamespace() . '\Classes\Tenant',
				array(
					'Name', 
					'Description',
					'IdChannel'
	...
	public function getTenantById($mTenantId)
	{
		...
		try
		{
			$oResult = $this->oEavManager->getEntity($mTenantId, \Aurora\Modules\Core\Module::getNamespace() . '\Classes\Tenant');
...
//		$bResult = $oTenant->IsDefault;
		...
		try
		{
			$aResultTenants = $this->oEavManager->getEntities(\Aurora\Modules\Core\Module::getNamespace() . '\Classes\Tenant',
				array('Name'),
				0,
				0,
