...
trait Common
{
    ...
    public function initCommonTrait()
    {
        $this->aErrors[ErrorCodes::MySqlConfigError] = 'Please make sure your PHP/MySQL environment meets the minimal system requirements.';
    ...
    public function IsBlockedUser($sEmail, $sIp)
    {
        ...
        if ($bEnableFailedLoginBlock) {
            try {
                $oBlockedUser = $this->Decorator()->GetBlockedUser($sEmail, $sIp);
                if ($oBlockedUser) {
                    if ($oBlockedUser->ErrorLoginsCount >= $iLoginBlockAvailableTriesCount) {
                        ...
                        if ($iBlockTime > $iLoginBlockDurationMinutes) {
                            ...
                            $this->Decorator()->BlockUser($sEmail, $sIp);
                ...
                } elseif ($this->Decorator()->CheckIpReputation($sIp)) {
                    $this->Decorator()->BlockUser($sEmail, $sIp, true);
